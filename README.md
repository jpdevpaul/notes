...
These pages are generated by the [Scripture](https://github.com/Predelnik/Scripture) tool, which produces searchable documentation of source code with cross-references of type definitions from global variable and function declarations. A Git commit hook ensures that new updates to this repository are instantly mirrored to the online documentation pages.
