...
| Category                                          | Progess                        |
|---------------------------------------------------|--------------------------------|
| [Functions](funcs/README.md)                      | 24% (472/1955 functions)       |
| [Global variables (read-only)](rdata/README.md)   | 95% (27040/28372 bytes)        |
| [Global variables (read-write)](data/README.md)   | 95% (187836/196860 bytes)      |
| [Global variables (uninitialized)](bss/README.md) | 86% (1774970/2048520 bytes)    |
