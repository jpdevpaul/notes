...
```c
// Type of effect caused by suffix, prefix of magic item or one of 5 or less effects of unique item.
typedef enum {
    ...
    ITEM_EFFECT_TYPE_FIRE_RESISTANCE_PLUS = 8,
    ITEM_EFFECT_TYPE_LIGHTNING_RESISTANCE_PLUS = 9,
    ITEM_EFFECT_TYPE_MAGIC_RESISTANCE_PLUS = 10,
    ITEM_EFFECT_TYPE_ALL_RESISTANCES_PLUS = 11,
    ...
    ITEM_EFFECT_TYPE_FASTER_ATTACK_SPEED = 58,
    ...
    ITEM_EFFECT_TYPE_MIN_AND_MAX_ATTACK_BONUS = 63, // used for Butcher's Cleaver
    ITEM_EFFECT_TYPE_CHANGE_DURABILITY = 64,
    ...
    ITEM_EFFECT_TYPE_FASTER_ATTACK_SPEED_3 = 67, // unused, same as ITEM_EFFECT_TYPE_FASTER_ATTACK_SPEED with value 3
    ...
    ITEM_EFFECT_TYPE_CONSTANT_INFRAVISION = 74, // unused
    ITEM_EFFECT_TYPE_CUSTOM_ARMOR_CLASS = 75, // unused
    ITEM_EFFECT_TYPE_ARMOR_CLASS_ADDED_TO_LIFE = 76, // unused
    ITEM_EFFECT_TYPE_10_PERCENT_MANA_ADDED_TO_ARMOR = 77, // unused
    ITEM_EFFECT_TYPE_FIRE_RESISTANCE_BASED_ON_CLVL = 78, // unused
...
```c
// ID characterizing item appearance.
// Frame number (11 + item_inv_graphics_id) from data/inv/objcurs.cel is used as item graphics for inventory.
typedef enum {
...
```c
// Bit flags used to describe unique, usually non-quantifiable effect on a player caused by items.
typedef enum {
    ITEM_SPECIAL_EFFECT_NONE = 0,
    ITEM_SPECIAL_EFFECT_CONSTANT_INFRAVISION = 1, // unused
    ITEM_SPECIAL_EFFECT_LIFE_STEAL_RANDOM = 2, // in range 0-12.5%
    ITEM_SPECIAL_EFFECT_FIRES_RANDOM_SPEED_ARROWS = 4,
    ITEM_SPECIAL_EFFECT_FIRE_ARROWS = 8,
    ITEM_SPECIAL_EFFECT_FIRE_DAMAGE_BONUS = 10h,
    ITEM_SPECIAL_EFFECT_LIGHTNING_DAMAGE_BONUS = 20h,
    ITEM_SPECIAL_EFFECT_CONSTANTLY_LOSE_HIT_POINTS = 40h,
    ITEM_SPECIAL_EFFECT_UNKNOWN_1 = 80h, // unused
    ITEM_SPECIAL_EFFECT_USER_CANT_HEAL = 100h,
    ITEM_SPECIAL_EFFECT_UNKNOWN_2 = 200h, // unused
    ITEM_SPECIAL_EFFECT_UNKNOWN_3 = 400h, // unused
    ITEM_SPECIAL_EFFECT_KNOCKS_TARGET_BACK = 800h,
    ITEM_SPECIAL_EFFECT_HIT_MONSTER_DOESNT_HEAL = 1000h, // unused
    ITEM_SPECIAL_EFFECT_MANA_STEAL_3_PERCENT = 2000h,
    ITEM_SPECIAL_EFFECT_MANA_STEAL_5_PERCENT = 4000h,
    ITEM_SPECIAL_EFFECT_LIFE_STEAL_3_PERCENT = 8000h,
    ITEM_SPECIAL_EFFECT_LIFE_STEAL_5_PERCENT = 10000h,
    ITEM_SPECIAL_EFFECT_FASTER_ATTACK_1 = 20000h, // Suffix: Readiness
    ITEM_SPECIAL_EFFECT_FASTER_ATTACK_2 = 40000h, // Suffix: Swiftness
    ITEM_SPECIAL_EFFECT_FASTER_ATTACK_3 = 80000h, // Suffix: Speed
    ITEM_SPECIAL_EFFECT_FASTER_ATTACK_4 = 100000h, // Suffix: Haste
    ITEM_SPECIAL_EFFECT_FASTER_HIT_RECOVERY_1 = 200000h, // Suffix: Balance
    ITEM_SPECIAL_EFFECT_FASTER_HIT_RECOVERY_2 = 400000h, // Suffix: Stability
    ITEM_SPECIAL_EFFECT_FASTER_HIT_RECOVERY_3 = 800000h, // Suffix: Harmony
    ITEM_SPECIAL_EFFECT_FAST_BLOCK = 1000000h,
    ITEM_SPECIAL_EFFECT_LIGHTNING_ARROWS = 2000000h,
    ITEM_SPECIAL_EFFECT_THORNS = 4000000h,
    ITEM_SPECIAL_EFFECT_NO_MANA = 8000000h,
    ITEM_SPECIAL_EFFECT_ABSORBS_HALF_OF_TRAP_DAMAGE = 10000000h,
    ITEM_SPECIAL_EFFECT_UNKNOWN_4 = 20000000h, // unused
    ITEM_SPECIAL_EFFECT_3X_DAMAGE_VS_DEMONS = 40000000h,
    ITEM_SPECIAL_EFFECT_ALL_RESISTANCES_EQUAL_0 = 80000000h,
} item_special_effect;
```
