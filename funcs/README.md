...
| [engine.cpp](engine.cpp)         | `0x4161FC`    | `0x41804D`  | 17% (10/57 functions)    |
...
| [gendung.cpp](gendung.cpp)       | `0x418C8B`    | `0x419E8A`  | 18% (4/22 functions)     |
...
| [items.cpp](items.cpp)           | `0x41F096`    | `0x425442`  | 6% (7/110 functions)     |
...
| [msg.cpp](msg.cpp)               | `0x43BBA4`    | `0x43F848`  | 0% (0/133 functions)     |
