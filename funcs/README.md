...
| [dthread.cpp](dthread.cpp)       | `0x415098`    | `0x415361`  | 100% (11/11 functions)   |
| [dx.cpp](dx.cpp)                 | `0x415362`    | `0x4158A8`  | 100% (17/17 functions)   |
| [effects.cpp](effects.cpp)       | `0x4158A9`    | `0x415F42`  | 14% (3/21 functions)     |
| [encrypt.cpp](encrypt.cpp)       | `0x415F43`    | `0x4161FB`  | 100% (8/8 functions)     |
| [engine.cpp](engine.cpp)         | `0x4161FC`    | `0x41804D`  | 66% (38/57 functions)    |
| [error.cpp](error.cpp)           | `0x41804E`    | `0x4182AC`  | 100% (3/3 functions)     |
...
| [interfac.cpp](interfac.cpp)     | `0x41B190`    | `0x41B813`  | 100% (9/9 functions)     |
...
| [mpqapi.cpp](mpqapi.cpp)         | `0x43AE90`    | `0x43BBA3`  | 100% (29/29 functions)   |
...
| [nthread.cpp](nthread.cpp)       | `0x440DAE`    | `0x44121C`  | 100% (15/15 functions)   |
...
| [pfile.cpp](pfile.cpp)           | `0x4498EC`    | `0x44A8E5`  | 100% (38/38 functions)   |
...
| [track.cpp](track.cpp)           | `0x4618A5`    | `0x4619A6`  | 40% (2/5 functions)      |
| [trigs.cpp](trigs.cpp)           | `0x4619A7`    | `0x462C6C`  | 19% (4/21 functions)     |
| [wave.cpp](wave.cpp)             | `0x462C6D`    | `0x46305F`  | 11% (2/18 functions)     |
